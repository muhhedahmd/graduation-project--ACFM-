...
const GenerateReport = ({ page }) => {
  ...
  useEffect(() => {
    const SCourseRep = reports.filter(
      (rep) => rep.courseid === MainDrawerCourse.courseid
    );
  ...
  const totalUnenrolled = parseInt(
    MainDrawerCourse?.studentsattending - MainDrawerCourse?.studentscompleting
  );
  const totalFailed = parseInt(
    MainDrawerCourse?.studentscompleting - MainDrawerCourse?.passed
  );
          ...
          >
            ...
            >
              ...
              Data.user.access === "Instructor" ? (
                ...
                <AddReport
                  mainReportState={mainReportState}
                  setMainReportState={setMainReportState}
                />
              )}
            </Box>
